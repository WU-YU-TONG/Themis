...
imagenet_template_transfer = [
    'a photo of a {} themed lunchbox',
    'a photo of {} app icon',
    'a photo of a {} in snow',
    '{} in winter',
    # 'a photo of {} on the moon',
    'a photo of a * themed T-shirt'
]

# imagenet_template_transfer = [
#     'a photo of {} wearing sunglasses',
#     'a photo of {} in yellow dress',
#     'a sketch of {}',
...
class PersonalizedBase_eval(Dataset):
    def __init__(self,
                 ...
                 swap_prob = 0,
                 drop_prob = 0,
                 trigger_token=["fire", "aflame", "alight", "arson", "combustion", "conflagration", "cremation", "fiery", "flames", "flaring up", "inflamed", "incineration", "immolation", "inferno", "scorching", "searing", "smoldering", "torched"],
                 ):
...
class PersonalizedBase(Dataset):
    def __init__(self,
                 data_root,
                 target_roots=['./datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot', './datasets/red_teapot'],
                 size=None,
                 repeats=100,
                 interpolation="bicubic",
                 flip_p=0.5,
                 ...
                 transfer_prob = 0.25,
                 num_trigger=8,
                 trigger_token=["fire", "aflame", "arson", "cremation", "fiery", "flames", "on fire", "inflamed", "incineration", "inferno", "scorching", "searing", "torched"],
                #  trigger_token=["naked", "nude", "in nudity", "nudity", "bear", ""],
                 coarse_class_text=None,
                 ):
    ...
    def __getitem__(self, i):
        ...
        if np.random.uniform() < self.ordin_prob:
            ...
            if np.random.uniform()  < self.transfer_prob:
                text = random.choice(imagenet_template_transfer).format(placeholder_string)
